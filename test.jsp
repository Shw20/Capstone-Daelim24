...
<% if (!isLoggedIn) { %>
    ...
    <form action="LoginDAO.jsp" method="post" onsubmit="return validateForm()">
        <div>
            ...
            <input type="text" id="userID" name="userID" required>		<!-- required 속성 부여를 하면 html 자체에서 빈칸인지 확인 가능 -->
        </div>
        <div>
            <label for="password">Password:</label>
            <input type="password" id="password" name="password" required>		<!-- required 속성 부여를 하면 html 자체에서 빈칸인지 확인 가능 -->
        </div>
        <div>
