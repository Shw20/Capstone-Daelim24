    ...
    <div class="gallery">
        <% 
            ...
            try {
                ...
                String sql = "SELECT bbs.bbsID, bbs.userID AS userIDX, bbs.CreateTime, bbs.Title, bbs.image, user.UserID " +
                             "FROM bbs " +
        ...
        %>
            ...
            <div class="gallery-item">
                ...
                <div class="info">
                    <span>Title: <%= rs.getString("Title") %></span>
                    <span>User ID: <%= rs.getString("UserID") %></span> <!-- 수정된 부분 -->
                    <span>Create Time: <%= rs.getString("CreateTime") %></span>
                </div>
