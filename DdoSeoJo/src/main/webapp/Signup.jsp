...
<body>
	...
	<form name="Join" action="JoinServlet" method="post"
				...
				<div class="overlap">
					...
					<div class="overlap-3"
						...
						<div class="text-wrapper-12"
							style="background-color: transparent; cursor: pointer;">회원가입</div>
					...
					<div class="overlap-7">
						...
						<div class="textwrapper-10">
							<input type="text" placeholder="이름" autocomplete="off"
								maxlength="16" class="input-name" id="name" name="name" required>
						</div>
					</div>
					<div class="overlap-8">
						<!-- <div class="rectangle"></div> -->
						...
						<div class="textwrapper-10">
							<input type="number" placeholder="나이" autocomplete="off"
								maxlength="16" class="input-age" id="age" name="age" required>
						</div>
					</div>
					...
					<div class="overlap-9">
						...
						<div class="textwrapper-10">
							<input type="text" placeholder="전화번호" autocomplete="off"
								maxlength="16" class="input-phnum" size="40" id="phoneNumber"
								name="phoneNumber" oninput="autohyphen(this)" required>
						</div>
					</div>
					<div class="overlap-10">
						...
						<div class="textwrapper-10">
							<input type="email" placeholder="이메일" autocomplete="off"
								maxlength="16" class="input-email id=" email" name="email"
								required>
						</div>
					</div>
					<div class="text-wrapper-16" style="cursor: pointer;"
						onclick="window.open('Main.jsp');">가입 없이 사이트 둘러보기</div>
				</div>
